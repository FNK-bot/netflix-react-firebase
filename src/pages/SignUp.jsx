                ...
                <div className="fixed w-full px-4 py-24 z-50 ">
                    <div className="max-w-[450px] h-[600px] bg-black/75 mx-auto text-white">
                        <div className="max-w-[320px] mx-auto py-16">
                            <h1 className="text-bold text-3xl">Sign Up</h1>
                            {error ? <p className='p-3 bg-red-500 my-3'>{error}</p> : null}
                            <form className='w-full flex flex-col py-4' onSubmit={handleSubmit}>
                                <input type="email" placeholder='Email' autoComplete='email'
                                    className='p-3 my-2 bg-gray-700 ' onChange={e => setEmail(e.target.value)}
                                />
                                ...
                                <p className='py-8'><span className='text-gray-500'>Already have an accoun?</span>
